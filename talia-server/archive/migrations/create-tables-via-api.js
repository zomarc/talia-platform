...
/**
 * Create tables directly in Supabase using REST API
 */
...
async function createBudgetTable() {
  ...
  try {
    await executeSQL(budgetTableSQL);
...
async function createPublishedRatesTable() {
  ...
  try {
    await executeSQL(publishedRatesTableSQL);
...
async function main() {
  console.log('🚀 Creating tables in Supabase via REST API...\n');
